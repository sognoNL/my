...
- (void)drawRect1:(CGRect)rect
{
    ...
    _shapeLayer.path=roundedRect.CGPath;
...
- (void)drawRect:(CGRect)rect
{
    ...
    [@"画圆：" drawInRect:CGRectMake(10, 20, 80, 20) withAttributes:attributes];
    [@"画线及孤线：" drawInRect:CGRectMake(10, 80, 100, 20) withAttributes:attributes];
    [@"画矩形：" drawInRect:CGRectMake(10, 120, 80, 20) withAttributes:attributes];
    [@"画扇形和椭圆：" drawInRect:CGRectMake(10, 160, 110, 20) withAttributes:attributes];
    [@"画三角形：" drawInRect:CGRectMake(10, 220, 80, 20) withAttributes:attributes];
    [@"画圆角矩形：" drawInRect:CGRectMake(10, 260, 100, 20) withAttributes:attributes];
    [@"画贝塞尔曲线：" drawInRect:CGRectMake(10, 300, 100, 20) withAttributes:attributes];
    [@"图片：" drawInRect:CGRectMake(10, 340, 80, 20) withAttributes:attributes];
    [@"圆图加字：" drawInRect:CGRectMake(10, 400, 80, 20) withAttributes:attributes];
    /*画圆*/
    //边框圆
    ...
    CGContextAddArcToPoint(context, fw, fh, fw-20, fh, radius);  // 右下角角度
    CGContextAddArcToPoint(context, 120, fh, 120, fh-20, radius); // 左下角角度
    CGContextAddArcToPoint(context, 120, 250, fw-20, 250, radius); // 左上角
    CGContextAddArcToPoint(context, fw, 250, fw, fh-20, radius); // 右上角
    CGContextClosePath(context);
    CGContextDrawPath(context, kCGPathFillStroke); //根据坐标绘制路径
...
//       CGContextDrawTiledImage(context, CGRectMake(0, 0, 20, 20), image.CGImage);//平铺图
    ...
    CGRect rect1 = CGRectMake(100.0f, 400.0f, 30, 30);
...
//    CGContextSetRGBFillColor (context, 1, 0, 0, 1.0);
    UIFont  *font1 = [UIFont boldSystemFontOfSize:12.0];
    NSMutableParagraphStyle *paragraphStyle = [[NSParagraphStyle defaultParagraphStyle] mutableCopy];
    paragraphStyle.alignment = NSTextAlignmentCenter;
    NSDictionary *attributes1 = @{NSFontAttributeName: font1,
                                 NSParagraphStyleAttributeName:paragraphStyle ,
                                 NSForegroundColorAttributeName:[UIColor redColor],NSStrokeColorAttributeName:[UIColor redColor]};
    [@"圈圈"  drawInRect:CGRectMake(100.0f, 408.0f,30, 15) withAttributes:attributes1];
